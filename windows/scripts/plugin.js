...
module.exports = function (ctx) {
    ...
    */
    plugin.foldersToCopy = [
        //windows81
        {
            "plugins/kapsel-plugin-logger/windows/windows81/bin/":
              "platforms/windows/plugins/kapsel-plugin-logger/windows81"
        },
        //windows10
        {
            "plugins/kapsel-plugin-logger/windows/windows10/bin/":
              "platforms/windows/plugins/kapsel-plugin-logger/windows10"
        }
    ];

    // Folders to remove during uninstall
    plugin.foldersToRemove = [
        path.join(plugin.rootdir, "platforms/windows/plugins/kapsel-plugin-logger")
    ];
